...
public final class StringUtils {
	 ...
	 * 
	 * @param charArray - Character array in ASCII
	 * @return Byte array representing chars
	 */
	public static byte[] toByte(char[] charArray)
	{
	 ...
	 * @param enc - Codification of the characters
	 * @return Byte array representing characters, password safe
	 * @throws CharacterCodingException Error when coding
	 */
	public static byte[] toByte(char[] charArray, String enc)
	throws CharacterCodingException
	{
		Charset charset = Charset.forName(enc);
		CharsetEncoder encoder = charset.newEncoder();

		CharBuffer charB = CharBuffer.wrap(charArray);
	 ...
	 * 
	 * @param byteArray - Byte array containing characters Shouldn't be used
	 *            with passwords, it uses intermediate strings
	 * @param enc - Encoding to use
	 * @return Character array
	 * @throws UnsupportedEncodingException if the encoding is not supported
	 */
	public static char[] toChar(byte[] byteArray, String enc)
	 ...
	 * 
	 * @param charArray - character array to crypt in sha1
	 * @return Generated sha1 hash
	 */
	public static String sha1(char[] charArray)
	{
		byte[] sha1hash = new byte[40];
